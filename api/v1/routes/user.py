...
@router.post("/", summary="Crear un nuevo usuario", response_model=User,responses={409: {"model": ErrorResponse, "description":"Conflicto: el usuario ya existe"}}, response_model_exclude={"hashed_password"}, response_description="Usuario creado exitosamente", status_code=status.HTTP_201_CREATED)
...
# ...existing code...
@router.post("/login",summary="Iniciar sesión", response_model=Token,response_description="Inicia sesión y devuelve un token de acceso",status_code=status.HTTP_200_OK)
