...
from exceptions.exceptions import PasswordNotFound, PasswordAlreadyExists
from schemas.password import GetPasswordResponse


router = APIRouter(prefix="/password", tags=["passwords"])

@router.post("/", summary="Crear una nueva contraseña",response_description="Contraseña creada exitosamente",response_model=PasswordResponse,responses={409: {"model": PasswordAlreadyExists, "description":"Contraseña ya existe"}} ,status_code=status.HTTP_201_CREATED)
