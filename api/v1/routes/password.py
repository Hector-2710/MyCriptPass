...
from exceptions.exceptions import PasswordNotExists
...
@router.get("/{service_name}",summary="Obtener una contraseña",responses={404: {"model": PasswordNotExists, "description":"Contraseña no encontrada"}}, response_description="Contraseña obtenida exitosamente", status_code=status.HTTP_200_OK)
